...
The **Museum With No Frontiers — Jewellery** gallery, built from the published
dataset `@museumwnf/jewellery-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/jewellery-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/jewellery/> through the reusable workflows in
