...
export default {
  ...
  home: {
    title: 'jewellery.identity.title',
    intro: 'jewellery.home.intro',
    cards: [
      {
        title: 'jewellery.nav.catalogue',
        description: 'jewellery.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'jewellery.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'jewellery.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'jewellery.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'jewellery.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'jewellery.partnerObjects.emptyPartner',
  //         emptyInstitution: 'jewellery.partnerObjects.emptyInstitution',
  //         institutionSummary: 'jewellery.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'jewellery.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'jewellery.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
