...
<template>
  <SiteShell
    v-bind="$attrs"
    header-home="#/"
    :footer-text="t('jewellery.identity.copyright')"
  >
    <template #brand>
      <span class="site-logo">
        <span class="site-logo-org">{{ t('jewellery.identity.organisation') }}</span>
        <span class="site-logo-title">{{ t('jewellery.identity.title') }}</span>
      </span>
    </template>
    <slot />
  </SiteShell>
