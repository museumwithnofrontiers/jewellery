...
// `useGalleryData.js` used to be byte-identical local copies of what jewellery
...
// legacy project key, no UUID — jewellery shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (jewellery-data 1.0.11+), an outside
